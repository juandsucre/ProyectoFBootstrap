        ...
        <div class="container">
          <div class="navbar-header">
            ...
            <div class="navbar-brand">
              <a href="index.html"><h1><span>Emple</span>ados</h1></a>
            </div>
          </div>
          ...
          <div class="navbar-collapse collapse">
            <div class="menu">
              <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="about.html">Buscar</a></li>
                <li role="presentation"><a href="services.html">Multimedia</a></li>
                <li role="presentation"><a href="portfolio.html">Generar PDF</a></li>
                <li role="presentation"><a href="blog.html">Informe Gráfico</a></li>
                <li role="presentation"><a href="contact.html">Registrarse / Iniciar Sesión</a></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="row slide-margin">
              <div class="col-sm-6">
                <div class="carousel-content">
                  <h2 class="animation animated-item-1">Bienvenido<span> a mi Proyecto Final</span></h2>
  ...
  <div class="about">
    <div class="container">
      ...
      <div class="col-md-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
        <h2 class="verde">Template built with Twitter Bootstrap</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus interdum erat libero, pulvinar tincidunt leo consectetur eget. Curabitur lacinia pellentesque libero, pulvinar tincidunt leo consectetur eget. Curabitur lacinia pellentesque libero,
          pulvinar tincidunt leo consectetur eget. Curabitur lacinia pellentesque
        ...
        <div class="col-sm-8">
          <div class="media contact-info wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
            ...
            <div class="media-body">
              ...
              <p class="have">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation +0123 456 70 80</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-4 col-md-offset-4">
          <div class="copyright">
            ...
            <div class="credits">
              ...
              -->
              Designed by <a href="https://bootstrapmade.com/">Juan D. Sucre</a></div>
          </div>
        </div>
      </div>
